                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <form action="{{ route('product.delete', $product->id) }}" method="POST"
                                ...
                                @method('DELETE')
                                <button type="submit"
                                        class="inline-flex items-center gap-1.5 px-3 py-2 text-sm font-medium rounded-lg border border-red-300 dark:border-red-600 text-red-600 dark:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/30 transition">
